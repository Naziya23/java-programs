class Country{
	static String[] countryName = {"India","SriLanka","England","SouthAfrica","USA","Pakistan","China"};
	static String listOfCapitals[] = {"New Delhi","Colombo","London","dontknow"};
	...
	public static void main(String a[]){
		...
		System.out.println(listOfCapitals[0] + " " + listOfCapitals[1] + " " + listOfCapitals[2] + " " + listOfCapitals[3] );
	}
}